  ...
  public class FileSystem
  {
    ...
    public static IDictionary<string, object> LoadFolderMetaData(FolderConfiguration configuration)
    {
      ...
      try
      {
        ...
        folderInfo = new Dictionary<string, object>(folderInfo)
        {
          ...
          { Constants.Configuration.ExitCode, 0 },
          { Constants.Configuration.ErrorMessage, string.Empty }
        };
      }
      catch (Exception ex)
      {
        ...
        folderInfo = new Dictionary<string, object>(folderInfo)
        {
          { Constants.Configuration.FolderSize, 0.0 },
          { Constants.Configuration.Modified, null },
          { Constants.Configuration.SubFoldersCount, 0 },
          { Constants.Configuration.SubFolders, null },
          { Constants.Configuration.FilesCount, 0 },
          { Constants.Configuration.Files, null },
          { Constants.Configuration.ExitCode, 1 },
          { Constants.Configuration.ErrorMessage, ex.ToString() }
        };
      }
    ...
    public static IDictionary<string, object> LoadFile(FileConfiguration configuration)
    {
      ...
      try
      {
        ...
        file = new Dictionary<string, object>(file)
        {
      ...
      catch (Exception ex)
      {
        ...
        file = new Dictionary<string, object>(file)
        {
          { Constants.Configuration.FileContent, string.Empty },
          { Constants.Configuration.FileSize, 0L },
          { Constants.Configuration.Modified, null },
          { Constants.Configuration.ExitCode, 1 },
          { Constants.Configuration.ErrorMessage, ex.ToString() }
        };
